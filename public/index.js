...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ContentItem)
/* harmony export */ });
    ...
    value: function initEvents() {
      ...
      this.DOM.caption.more.forEach(function (more, pos) {
        ...
        more.addEventListener('mouseenter', function () {
          gsap__WEBPACK_IMPORTED_MODULE_3__.gsap.killTweensOf([img, chars]);
...
var Cursor = /*#__PURE__*/function () {
  function Cursor(el) {
    ...
    this.onMouseMoveEv = function () {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(_this.DOM.el, {
        duration: 0.9,
        ease: 'Power3.easeOut',
        opacity: 1
      });
  ...
  _createClass(Cursor, [{
    ...
    value: function render() {
      ...
      for (var key in this.renderedStyles) {
        this.renderedStyles[key].previous = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.lerp)(this.renderedStyles[key].previous, this.renderedStyles[key].current, this.renderedStyles[key].amt);
      }
...
/* harmony import */ var _contentItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contentItem */ "./src/js/contentItem.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var MenuController = /*#__PURE__*/function () {
  function MenuController(menuEl) {
    ...
    this.DOM.menuItems.forEach(function (menuItemEl) {
      return _this.menuItems.push(new _menuItem__WEBPACK_IMPORTED_MODULE_0__.default(menuItemEl, _this.animatableProperties));
    ...
    _toConsumableArray(document.querySelectorAll('.content-wrap .content')).forEach(function (contentItemEl) {
      return _this.contentItems.push(new _contentItem__WEBPACK_IMPORTED_MODULE_1__.default(contentItemEl));
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./src/js/utils.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../img/epa/*.jpg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }
 ...
 // const images = Object.entries(require('../img/epa/1.jpg'));

var images = Object.entries(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../img/epa/*.jpg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // track the mouse position
...
window.addEventListener('mousemove', function (ev) {
  return mousepos = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.getMousePos)(ev);
});
...
var MenuItem = /*#__PURE__*/function () {
  ...
  _createClass(MenuItem, [{
    ...
    value: function showImage() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.killTweensOf(this.DOM.revealInner);
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.killTweensOf(this.DOM.revealImage);
      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
        defaults: {
          duration: 0.8,
          ease: 'quint'
        ...
        onStart: function onStart() {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(_this2.DOM.el, {
    ...
    value: function hideImage() {
      ...
      return new Promise(function (resolve) {
        // kill any current tweens
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.killTweensOf(_this3.DOM.revealInner);
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.killTweensOf(_this3.DOM.revealImage);
        gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.timeline({
          defaults: {
            duration: 0.8,
            ease: 'quint'
          ...
          onStart: function onStart() {
            gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(_this3.DOM.el, {
              zIndex: 1
            });
          },
          onComplete: function onComplete() {
            gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(_this3.DOM.reveal, {
              opacity: 0
            });
            resolve();
          }
    ...
    value: function render() {
      ...
      var mouseDistanceX = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.clamp)(Math.abs(mousePosCache.x - mousepos.x), 0, 100); // direction where the mouse is moving
      ...
      this.animatableProperties.rotation.current = this.firstRAFCycle ? 0 : (0,_utils__WEBPACK_IMPORTED_MODULE_0__.map)(mouseDistanceX, 0, 200, 0, direction.x < 0 ? -100 : 100); // set up the interpolated values
      ...
      this.animatableProperties.tx.previous = this.firstRAFCycle ? this.animatableProperties.tx.current : (0,_utils__WEBPACK_IMPORTED_MODULE_0__.lerp)(this.animatableProperties.tx.previous, this.animatableProperties.tx.current, this.animatableProperties.tx.amt);
      this.animatableProperties.ty.previous = this.firstRAFCycle ? this.animatableProperties.ty.current : (0,_utils__WEBPACK_IMPORTED_MODULE_0__.lerp)(this.animatableProperties.ty.previous, this.animatableProperties.ty.current, this.animatableProperties.ty.amt);
      this.animatableProperties.rotation.previous = this.firstRAFCycle ? this.animatableProperties.rotation.current : (0,_utils__WEBPACK_IMPORTED_MODULE_0__.lerp)(this.animatableProperties.rotation.previous, this.animatableProperties.rotation.current, this.animatableProperties.rotation.amt); // set styles

      gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.set(this.DOM.reveal, {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "img/avatar1.png");
...
/* harmony import */ var _img_avatar1_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../img/avatar1.png */ "./src/img/avatar1.png");
...
/* harmony import */ var _preloader__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./preloader */ "./src/js/preloader.js");
/* harmony import */ var _cursor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cursor */ "./src/js/cursor.js");
/* harmony import */ var _menuController__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./menuController */ "./src/js/menuController.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
window.addEventListener('load', function (event) {
  gsap__WEBPACK_IMPORTED_MODULE_11__.gsap.fromTo('#epa', {
    x: 100
  }, {
    x: 100,
    duration: 2000
...
Promise.all([(0,_preloader__WEBPACK_IMPORTED_MODULE_8__.preloader)('.menu__item'), (0,_utils__WEBPACK_IMPORTED_MODULE_7__.preloadImages)('.gallery__item-imginner'), (0,_utils__WEBPACK_IMPORTED_MODULE_7__.preloadFonts)('zkq2mjw')]).then(function () {
  //Remove loader(loading class)
  document.body.classList.remove('loading'); //Initialize custom cursor

  var cursor = new _cursor__WEBPACK_IMPORTED_MODULE_9__.default(document.querySelector('.cursor')); //initialize the MenuController

  new _menuController__WEBPACK_IMPORTED_MODULE_10__.default(document.querySelector('.menu')); // Mouse effects on all links and buttons
