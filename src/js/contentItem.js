...
export default class ContentItem {
    constructor(el) {
            ...
            this.DOM.imgs = [
                ...this.DOM.el.querySelectorAll('.gallery__item-imginner'),
            ]
            this.DOM.caption = {
                title: this.DOM.el.querySelectorAll(
                    '.gallery__item-caption > .gallery__item-title'
                ),
                meta: this.DOM.el.querySelectorAll(
                    '.gallery__item-caption > .gallery__item-meta'
                ),
                more: this.DOM.el.querySelectorAll(
                    '.gallery__item-caption > .gallery__item-more'
                ),
            }
