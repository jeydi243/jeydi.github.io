...
var images = Object.entries(__webpack_require__(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../img/epa/*.jpg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()))); // track the mouse position
  ...
  _createClass(MenuItem, [{
    ...
    value: function showImage() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
        ...
        onStart: function onStart() {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(_this2.DOM.el, {
    ...
    value: function hideImage() {
      ...
      return new Promise(function (resolve) {
        // kill any current tweens
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.killTweensOf(_this3.DOM.revealInner);
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.killTweensOf(_this3.DOM.revealImage);
        gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.timeline({
          defaults: {
            duration: 0.8,
            ease: 'quint'
          ...
          onStart: function onStart() {
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(_this3.DOM.el, {
              zIndex: 1
            });
          },
          onComplete: function onComplete() {
            gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(_this3.DOM.reveal, {
              opacity: 0
            });
            resolve();
          }
...
/* harmony import */ var _menuController__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./menuController */ "./src/js/menuController.js");
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
window.addEventListener('load', function (event) {
  gsap__WEBPACK_IMPORTED_MODULE_9__.gsap.fromTo('#epa', {
    x: 100
  }, {
    x: 100,
    duration: 2000
...
Promise.all([(0,_preloader__WEBPACK_IMPORTED_MODULE_6__.preloader)('.menu__item'), (0,_utils__WEBPACK_IMPORTED_MODULE_5__.preloadImages)('.gallery__item-imginner'), (0,_utils__WEBPACK_IMPORTED_MODULE_5__.preloadFonts)('zkq2mjw')]).then(function () {
  // Remove loader (loading class)
  document.body.classList.remove('loading'); // Initialize custom cursor

  var cursor = new _cursor__WEBPACK_IMPORTED_MODULE_7__.default(document.querySelector('.cursor')); // Initialize the MenuController

  new _menuController__WEBPACK_IMPORTED_MODULE_8__.default(document.querySelector('.menu')); // Mouse effects on all links and buttons
